...
import "../Forbidden.css"; // تأكد من وضع تنسيق CSS الخاص بك هنا
...
const Forbidden = () => {
  return (
    <div>
      ...
      <Link
        className="mt-6 block w-fit mx-auto hover:bg-transparent hover:border-sky-400 border border-transparent duration-200 rounded-md bg-sky-400 text-white text-center px-4 py-2"
        href={"/"}
      >
        go Home
      </Link>
